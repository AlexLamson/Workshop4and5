...
export default class Comment extends React.Component {
  constructor(props) {
    super(props);
    // The Comment's initial state is what the FeedItem passed to us.
  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.props.feedItemIndex, this.props.index, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.props.feedItemIndex, this.props.index, 4, callbackFunction);
      }
    }
  }
